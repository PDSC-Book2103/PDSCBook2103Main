...
\lowertitleback{
	\textbf{Disclaimer}\\
	Edited.  This is lualatex! Try 2!!! - try 3. Use package fontspec. Now switching to input... It seems input file works.  Now I have added setmainfont FreeSerif.
