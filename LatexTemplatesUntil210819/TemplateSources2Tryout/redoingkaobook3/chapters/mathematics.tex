...
\begin{proof}
The proof is left to the reader as a trivial exercise. Hint: I removed some blind text here.
\end{proof}
...
I removed some blind text here.
\end{kaobox}
...
\begin{kaocounter}
	I also removed some blind text here.
\end{kaocounter}
