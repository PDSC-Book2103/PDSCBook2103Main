...
it is referenced. Blah, blah, blah.

Here we try to adapt this template to typeset greek. We start by
looking at the \href{https://github.com/fmarotta/kaobook/blob/master/examples/documentation/main.tex}
{documentation}.  Please see lines 8ff.
